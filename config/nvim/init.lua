...
-- Use OSC52 outside Wayland. On Wayland, Neovim automatically uses wl-copy.
if vim.env.WAYLAND_DISPLAY == nil and (vim.env.WEZTERM_EXECUTABLE ~= nil or vim.env.SSH_CONNECTION) then
