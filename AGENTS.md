...
- If commiting code, write a commit message that naturally continues the sentence "This commit...", but without writing the part in quotes.
- Use migrations to _prepare_ existing systems for new changes (e.g., package installs, configuration file changes, etc.).
- Don't use migrations to _apply_ new changes - that happens via install scripts and templates.
